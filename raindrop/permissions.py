...
def purchase_order_query(user):
    ...
    user_list = ["Administrator", "umesh.sharma@hpl.com.np", "bimala.khadka@hpl.com.np", "surya.karki@hpl.com.np", "keshav.kc@hpl.com.np", "krishna.pradhan@hpl.com.np", "chaman.bk@hpl.com.np", "rajiv.ramdam@hpl.com.np"]
